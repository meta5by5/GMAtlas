...
- [ ] Phase 10 (in progress) — Merchant Rules Lens (contract-driven trade, Trade drawer, tag-driven Location economy types), Faction Pressure Track, Mission generator, Traveller/SWN/CWN content, Enhancements (renamed from Cybernetics), Game Mechanics Index, Expedition trackers, Diplomacy fields, Suggestion Lenses, and lightweight rich text (Journal/Guide/Situation/Focus/Overview toolbars, mention page-editing) all done; Shipyard companion link and a sync adapter still open
