...
- [ ] Phase 14 (in progress) — Storyboard re-layout: the Story Dashboard/Narrative Composer/Co-Pilot trio renamed to Composer/Navigator/Advisor everywhere, split into real sibling panels, and the Advisor now shares the drawer tab strip (flagged when a decision is pending) instead of being covered by an open drawer (`design/UX-ROADMAP.md` Steps 1–3) done; the phone/tablet unified tab menu, a phone-tier polish pass, and the Moves-menu icon placement check still open
