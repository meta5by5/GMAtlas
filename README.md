...
- [ ] Phase 11 (in progress) — Visual & Tactical Tools: Gallery (per-entity thumbnails + a tagged image collection) done; Planetfall Grid Battlemap, Planetfall Base Builder, Encounter Manager, Interactive Maps, and external rich-text links still open
