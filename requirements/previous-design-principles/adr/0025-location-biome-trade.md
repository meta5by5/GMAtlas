...
See `docs/archive/adr/0025-location-biome-trade.md` (merging biome into
development level as one bigger enum, keeping development level as a tag
forever, and a hard commodity allow/deny list per biome were each
