...
See `docs/archive/adr/0023-planetfall-grid-battlemap.md` (SVG/`<canvas>`
rendering, a new drag-threshold system, a real drag gesture for palette
icons, a parallel image-upload path, and a fixed non-toggleable grid were
