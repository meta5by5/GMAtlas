...
See `docs/archive/adr/0019-where-tab-and-scene-fields.md` (chip buttons
for the WHERE tag list, a separate Scene-field oracle-link map, and a
two-way Scene-field/combined-text binding were each considered and
rejected).
