...
See `docs/archive/adr/0039-reference-library-release-hosting-and-story-
options.md` (Part A: a runtime fallback, overloading `file` as a URL, a
full LFS history rewrite; Part B: a bring-your-own-PDF flow, folding
Story Options into `advise()`, and a same-pass WHAT-tab/Co-Pilot version
were each considered and rejected or deferred).
