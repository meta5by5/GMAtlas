...
See `docs/archive/adr/0018-lightweight-rich-text.md` (live `execCommand`
formatting, double-click page-editing, true nested lists, and a live
import/seed button were each considered and rejected).
