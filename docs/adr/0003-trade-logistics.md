...
See `docs/archive/adr/0003-trade-logistics.md` (reordering the roadmap so
Trade lands earlier, waiting for a Traveller sourcebook, a full economic
simulation, and a bespoke in-transit progress mechanic were each
