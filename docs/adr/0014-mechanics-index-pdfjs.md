...
See `docs/archive/adr/0014-mechanics-index-pdfjs.md` (a hand-curated data
file with no PDF.js, a `disableWorker`-style getDocument option, and
building the Mechanics Index at `npm run build` time were each considered
and not chosen).
