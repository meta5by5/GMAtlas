...
See `docs/archive/adr/0011-swn-cwn-content.md` (transcribing SWN's/CWN's
actual tables and catalogs, faction-vs-faction opposed combat, adding CWN
as a seventh Rules Constitution provider, and a full CWN urban/cyberpunk
content pack were each considered and rejected).
