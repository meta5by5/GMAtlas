...
See `docs/archive/adr/0041-scene-operating-model.md` (one giant pass
building everything described, a weighted-preference oracle "learning"
layer, and auto-deriving Bystanders from location presence were each
