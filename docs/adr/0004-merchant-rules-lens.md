...
See `docs/archive/adr/0004-merchant-rules-lens.md` (scoping all 8 phases
of the three source documents as a literal build spec, keeping buy/sell
as the primary framing, a separate `domain/contracts.js` module, and
building the full "Living Galaxy" colony record now were each considered
and rejected).
