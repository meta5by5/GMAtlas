...
See `docs/archive/adr/0021-gallery.md` (storing image data directly on the
entity, reusing the Oracle tag-lock mechanism, and always storing an
"original" record were each considered and rejected).
