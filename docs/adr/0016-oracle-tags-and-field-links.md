...
See `docs/archive/adr/0016-oracle-tags-and-field-links.md` (a rigid
1-field-to-1-table link with no tags, one bespoke tag per field, and
storing tags as a diff/patch on the seed were each considered and
rejected).
