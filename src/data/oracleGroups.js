...
export const ORACLE_GROUPS = [
  ...
  { label: '📚 Story Beats', children: ['Plot Engine', 'Story', 'Adventure', 'Missions', 'Mission Aftermath', 'Mysteries & Coverups'] },
  ...
  { label: '🚀 Space Operations', children: ['Starships', 'Space Encounters', 'Space Operations', 'Trade & Cargo', 'Industrial Hazards', 'Exploration'] },
