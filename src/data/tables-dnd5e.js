// tables-dnd5e.js — the D&D 5e genre pack's own oracle table set. Direct
// request: "associating all of this to the 'Fantasy (D&D-style)' genre
// pack... everything including the oracles must be independent or a copy
// allocated to this version so it can be customized to D&D game system" —
// this is a REAL, independent copy of tables-fantasy.js's own content as
// its starting seed (same original in-house voice, not a transcription of
// any sourcebook), forked into its own file/export/genre-pack id so future
// edits here never touch tables-fantasy.js (or any other campaign using
// the 'fantasy' pack) and vice versa. The two are allowed to diverge from
// this point on — this is a snapshot at fork time, not a live link.
//
